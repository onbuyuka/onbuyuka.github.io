...
export const projects: Project[] = [
  {
    ...
    description:
      'Pick group winners, advance the best third-placed teams and predict a champion, then flip on Live mode to track real results and score your bracket — with squads, kits, form and fixtures in your own time zone. Live data refreshes daily via a scheduled GitHub Action.',
  ...
  },
  {
    ...
    description:
      'Build hypothetical portfolios, log buys and sells for any ticker, and track realized/unrealized P&L against a daily price snapshot — then pit alternative portfolios against each other. Everything runs in the browser with live quotes fetched client-side; no backend, no real money.',
  ...
  },
  {
    ...
    description:
      'A responsive wedding site with auto-detected language (English/Turkish), an RSVP form backed by Google Sheets, and guest photo uploads via Cloudinary. Deployed on a custom domain.',
